module.exports = {
  ...
  extends: [
    "eslint: recommended",
    "plugin:react/recommended", // 14~17,23行目と同じ設定。（どっちかがあれば使える）
    "plugin:react-hooks/recommended",
    "plugin:jsx-a11y/recommended", // 一番効いてほしいプラグインは最後に指定する
    "prettier",
  ],
  rules: {
  ...
  settings: {
    React: {
      version: "detect", //package.jsonのReactをみて、Reactのバージョンを決めている
    },
  },
};
